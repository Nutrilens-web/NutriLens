...
Пользователь: ${settings.userContext}. Дневной лимит калорий: ${settings.dailyGoal} ккал.${useRemainingCalories ? ` Свободно на сегодня: ${remainingCalories} ккал (подбери блюда, которые не превысят этот остаток).` : ' Подбери блюда в рамках дневного лимита.'}
