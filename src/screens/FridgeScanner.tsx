...
Предложи 3 здоровых рецепта, используя ПРЕИМУЩЕСТВЕННО то, что видишь на фото${useRemainingCalories ? ', стараясь вписаться в оставшиеся калории (если их много — можно сытнее, если мало — более лёгкие)' : ''}. Для каждого рецепта:
